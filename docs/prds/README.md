# Rev — Product Requirements Documents

## Overview

Rev is an AI-powered code review desktop application built with Tauri v2, SvelteKit, Elysia, Effect, and SQLite. These PRDs define the remaining feature scope from the current state of the codebase, broken into sequentially buildable pieces.
...
- **Desktop**: Tauri v2 window, deep-link handling (`rev://`), sidecar server spawning
