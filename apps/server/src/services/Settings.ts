  ...
  getSettings: () =>
    Effect.gen(function* () {
      ...
      yield* Effect.tryPromise({
        try: () =>
          Promise.resolve(db.insert(userSettings).values(insertValues).run()),
