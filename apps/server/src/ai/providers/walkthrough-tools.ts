...
function phaseAtLeast(phase: WalkthroughPipelinePhase, min: WalkthroughPipelinePhase): boolean {
  return PHASE_ORDER[phase] >= PHASE_ORDER[min];
}

function phaseAtMost(phase: WalkthroughPipelinePhase, max: WalkthroughPipelinePhase): boolean {
