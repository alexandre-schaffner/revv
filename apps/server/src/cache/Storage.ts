...
export interface StorageBackend {
  ...
  readonly readOne: (ns: string, key: string) => Effect.Effect<CacheRow | null, never, DbService>;
  readonly writeOne: (row: CacheRow) => Effect.Effect<void, never, DbService>;
  readonly deleteOne: (ns: string, key: string) => Effect.Effect<void, never, DbService>;
  readonly deleteByPrefix: (ns: string, keyPrefix: string) => Effect.Effect<void, never, DbService>;
  ...
  readonly bounds: (
    ns: string,
  ) => Effect.Effect<{ oldestAt: string | null; newestAt: string | null }, never, DbService>;
