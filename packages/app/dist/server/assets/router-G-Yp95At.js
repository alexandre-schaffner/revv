...
const appCss = "/assets/globals-Gznp5urT.css";
...
createServerFn({
  method: "POST"
}).inputValidator((input) => input).handler(createSsrRpc("c1baaa23f5ac30b706e5a8a2e00ca80abcd7882a06a9855abd7c53818e63e41d"));
const getCommandById = createServerFn({
  method: "GET"
}).inputValidator((input) => input).handler(createSsrRpc("1f0995f68a80beb9a31792fdda94f20fc08cd6ced8dec3ebdfab4956d190e427"));
createServerFn({
  method: "GET"
}).inputValidator((input) => input).handler(createSsrRpc("37fc7ba39a98604c44c3062c570eaeb7ec32d2b5723607a171981a1e635a711c"));
const getPendingCommands = createServerFn({
  method: "GET"
}).inputValidator((input) => input).handler(createSsrRpc("23f0c1fbc962bda55ab6ae06dda93074f3ff0b9f7d04f0358145ebb7d70636e8"));
const approveCommand = createServerFn({
  method: "POST"
}).inputValidator((input) => input).handler(createSsrRpc("474f73c8949fd4b5a6752e322fc74be2c4aea69ad32abe8086af9a74296c9a03"));
const denyCommand = createServerFn({
  method: "POST"
}).inputValidator((input) => input).handler(createSsrRpc("8eb2a73f852d906826ef6b1cd48eae720f61c025e187aa8c8f641104e5488c54"));
function ApprovalBlock() {
  ...
  const handleDeny = async (cmdId) => {
    await denyCommand({ data: { id: cmdId } });
    poll();
  };
  if (pending.length === 0) {
    return /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground/50 font-mono", children: "no pending commands" });
  }
  return /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-1", children: pending.map((entry) => /* @__PURE__ */ jsxs(
    "div",
    {
      className: "flex items-center gap-2 text-xs font-mono",
      children: [
        /* @__PURE__ */ jsx("span", { className: "text-muted-foreground shrink-0", children: entry.block }),
        /* @__PURE__ */ jsxs("span", { className: "text-foreground truncate", children: [
          entry.cmd,
        ...
        /* @__PURE__ */ jsxs("div", { className: "ml-auto flex items-center gap-1 shrink-0", children: [
          ...
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx("svg", { width: "12", height: "12", viewBox: "0 0 12 12", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", children: /* @__PURE__ */ jsx("path", { d: "M3 3l6 6M9 3l-6 6" }) })
            }
          )
        ] })
      ]
...
const getCwd = createServerFn({
  method: "GET"
}).handler(createSsrRpc("d03c71cd5c510dab790b98186c51b21bcf1b7c4e858da08e9fce913bff246aad"));
const setCwd = createServerFn({
  method: "POST"
}).inputValidator((input) => input).handler(createSsrRpc("3a2cd06103932f9fa5c6f559d7a09da6b4e90f0be36d556f82fc6f6ef6e9b881"));
const getGitRepos = createServerFn({
  method: "GET"
}).handler(createSsrRpc("ccc49305a43e8379867a893b15f40f019d2f0b42188f65a6dd20619403b94ff0"));
function CwdBlock() {
  const [cwd, setCwdState] = useState(null);
  ...
  return /* @__PURE__ */ jsxs(Popover, { open, onOpenChange: setOpen, children: [
    ...
    /* @__PURE__ */ jsx(PopoverContent, { align: "start", side: "top", className: "w-auto max-w-md p-1", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
      repos.length === 0 && /* @__PURE__ */ jsx("span", { className: "px-3 py-2 text-xs text-muted-foreground", children: "Scanning…" }),
      repos.map((repo) => /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
          onClick: () => handleSelect(repo),
          className: `text-left px-3 py-1.5 text-xs font-mono rounded-sm hover:bg-accent hover:text-accent-foreground transition-colors ${repo === cwd ? "text-foreground font-medium" : "text-muted-foreground"}`,
          children: repo
        },
        repo
      ))
...
const requestLs = createServerFn({
  method: "POST"
}).handler(createSsrRpc("72414761d666b5dd6ca5c883d88652a9db0f4191a99660ba1b8249e2d06904ce"));
...
function FilesBlock() {
  ...
  const requestFiles = useCallback(async () => {
    ...
    pollRef.current = setInterval(async () => {
      ...
      if (updated.status === "done" || updated.status === "error") {
        ...
        const lines = (((_a = updated.result) == null ? void 0 : _a.stdout) ?? "").split("\n");
        setFiles(lines.map(parseLsLine).filter((f) => f !== null));
        setStatus("done");
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-border", children: [
      /* @__PURE__ */ jsx("span", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wider", children: "Files" }),
      /* @__PURE__ */ jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex-1 overflow-y-auto py-1", children: [
      status === "pending" && /* @__PURE__ */ jsx("span", { className: "px-3 py-2 text-xs text-muted-foreground block", children: "Awaiting approval…" }),
      status === "denied" && /* @__PURE__ */ jsx("span", { className: "px-3 py-2 text-xs text-muted-foreground block", children: "Command denied." }),
      status === "done" && files.length === 0 && /* @__PURE__ */ jsx("span", { className: "px-3 py-2 text-xs text-muted-foreground block", children: "Empty directory." }),
      files.map((file) => /* @__PURE__ */ jsxs(
        "div",
        {
          className: "flex items-center gap-2 px-3 py-0.5 text-xs font-mono hover:bg-accent/50 transition-colors",
          children: [
            /* @__PURE__ */ jsx("span", { className: "text-muted-foreground w-3 text-center shrink-0", children: file.isDir ? "d" : " " }),
            /* @__PURE__ */ jsx("span", { className: file.isDir ? "text-foreground" : "text-muted-foreground", children: file.name })
          ]
        },
        file.name
      ))
...
function RootComponent() {
  return /* @__PURE__ */ jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "flex min-h-screen flex-col", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-1 min-h-0", children: [
        /* @__PURE__ */ jsx("aside", { className: "w-56 border-r border-border bg-muted/50 overflow-hidden flex flex-col", children: /* @__PURE__ */ jsx(FilesBlock, {}) }),
        /* @__PURE__ */ jsx("main", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsx(Outlet, {}) })
      ] }),
      /* @__PURE__ */ jsxs("footer", { className: "flex items-center border-t border-border bg-muted px-4 py-2 gap-3", children: [
        /* @__PURE__ */ jsx(CwdBlock, {}),
        /* @__PURE__ */ jsx("div", { className: "w-px self-stretch bg-border" }),
        /* @__PURE__ */ jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsx(ApprovalBlock, {}) })
      ] }),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter = () => import("./index-DjT1WtM5.js");
